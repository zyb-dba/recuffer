...
import (
	...
	"github.com/recuffer/pkg/utils/bytesize"
	"github.com/recuffer/pkg/utils/errors"
	"github.com/recuffer/pkg/utils/log"
	"github.com/recuffer/pkg/utils/timesize"
)
...
#   1. product_auth is used for auth validation among recuffer.
...
type Config struct {
	...
	ClusterAddr       string `toml:"cluster_addr" json:"cluster_addr"`
	ReadBlackList     string `toml:"read_blacklist" json:"read_blacklist"`
	ClientIpBlackList string `toml:"clientip_blacklist" json:"clientip_blacklist"`
	CMDBlackList      string `toml:"cmd_blacklist" json:"cmd_blacklist"`
	MovedConnPoolSize int    `toml:"movedconn_pool_size" json:"movedconn_pool_size"`
